          ...
          addedPhotos.map((link) => (
            <div className="h-32 flex relative" key={link}>
              ...
              <button
                ...
                className="absolute bottom-1 right-1 bg-gray-100 bg-opacity-70 p-1 rounded-2xl"
              >
                <svg
              ...
              <button
                ...
                className="absolute bottom-1 left-1 bg-gray-100 bg-opacity-70 p-1 rounded-2xl"
              >
                {link === addedPhotos[0] ? (
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
